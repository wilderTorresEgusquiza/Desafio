var FormWizard = /** @class */ (function () {
    function FormWizard(elementId, options) {
        ...
        this.finishControl = this.find('[data-step-control-finish]');
    ...
    FormWizard.prototype.activateStep = function (stepNumber, increment) {
        ...
        if (this.options.showFinishButton) {
            if (this.isLastStep()) {
                this.nextControl.style['display'] = 'none';
                this.finishControl.style['display'] = 'inline-flex';
            }
            else {
                this.nextControl.style['display'] = 'inline-flex';
                this.finishControl.style['display'] = 'none';
            }
        }
    };
    FormWizard.prototype.isLastStep = function () {
        return this.currentStep === this.totalStepsCount;
    };
