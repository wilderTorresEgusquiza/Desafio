...
gulp.task('email_templates', function (done) {
...
gulp.task('browser-sync', function(done) {
  ...
  gulp.watch('src/admin/html/**/*.html', gulp.series('html'));
  gulp.watch('src/admin/scss/**/*.scss', gulp.series('scss:base:source', 'scss:base:minify'));
  gulp.watch('src/admin/js/**/*.js', gulp.series('js:source', 'js:minify'));
  gulp.watch('src/admin/ts/form-wizard/*.ts', gulp.series('ts:form-wizard'));
  gulp.watch('src/admin/email_templates/**/*.mjml', gulp.series('email_templates'));
...
function app(appName) {
  ...
  gulp.task('app:' + appName + ':fonts', function(done) {
  ...
  gulp.task('app:' + appName + ':watch', function(done) {
    gulp.watch('./src/apps/' + appName + '/html/**/*.html', gulp.series('app:' + appName + ':html'));
    gulp.watch('./src/apps/' + appName + '/scss/**/*.scss', gulp.series(
      'app:' + appName + ':scss:source',
      'app:' + appName + ':scss:minify')
    );
    gulp.watch('./src/apps/' + appName + '/js/**/*.js', gulp.series(
  ...
  gulp.task('app:' + appName + ':run', gulp.series(
    'app:' + appName + ':html',
    'app:' + appName + ':js:source',
    'app:' + appName + ':js:minify',
    'app:' + appName + ':img',
  ...
  gulp.task('app:' + appName + ':watch:run', gulp.series('app:' + appName + ':watch'));

  // run
  gulp.task('app:' + appName + ':run')();
  gulp.task('app:' + appName + ':watch:run')();
}
...
function customLayout(layoutName) {
  ...
  gulp.task('custom-layout:' + layoutName + ':fonts', function(done) {
  ...
  gulp.task('custom-layout:' + layoutName + ':watch', function(done) {
    gulp.watch('./src/custom-layouts/' + layoutName + '/html/**/*.html', gulp.series('custom-layout:' + layoutName + ':html'));
    gulp.watch('./src/custom-layouts/' + layoutName + '/scss/**/*.scss', gulp.series(
      'custom-layout:' + layoutName + ':scss:source',
      'custom-layout:' + layoutName + ':scss:minify')
    );
    gulp.watch('./src/custom-layouts/' + layoutName + '/js/**/*.js', gulp.series(
  ...
  gulp.task('custom-layout:' + layoutName + ':run', gulp.series(
  ...
  gulp.task('custom-layout:' + layoutName + ':watch:run', gulp.series(
    'custom-layout:' + layoutName + ':watch'
  ));

  gulp.task('custom-layout:' + layoutName + ':run')();
  gulp.task('custom-layout:' + layoutName + ':watch:run')();
}
...
gulp.task('default', gulp.series(
  ...
  'vendor', 'data', 'ts:form-wizard', 'browser-sync'
));
